...
{
	partial class FrmReportedelosproductos
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.dataSetProducto = new Sistemaderopa.DataSetProducto();
			...
			reportDataSource1.Value = this.dataSetProductoBindingSource;
			this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "Sistemaderopa.InformeProductos.rdlc";
			...
			this.btnbuscar.Location = new System.Drawing.Point(187, 132);
			...
			this.btnimprimir.Location = new System.Drawing.Point(300, 132);
			...
			this.Name = "FrmReportedelosproductos";
			this.Text = "Reportedelosproductos";
